        ...
        <div class="container">
          <div class="row">
            ...
            <div class="left">
              <h4>ADVENTURE</h4>
              <h1>
                Almost on top of the Everest, a picture is worth a thousand
                words
              </h1>
              <div class="list-users-01">
                <ul class="images">
                  ...
                  <li><img src="../assets/images/list_user3.jpg" alt="Zola" /></li>
                  <li><img src="../assets/images/list_user4.jpg" alt="Zola" /></li>
                  <li><img src="../assets/images/list_user5.jpg" alt="Zola" /></li>
                </ul>
            ...
            <div class="block-style-1">
              ...
              <div class="block-content">
                <div class="block-content_header">
                  <img src="../assets/images/profile_1.jpg" alt="Zola" />
                  <p>Louis Miller</p>
                </div>
                <div class="block-content_thumbnail">
                  <span class="bg-red">Sport</span>
                  <a href="#">
                    <img src="../assets/images/thumbnail_01.jpg" alt="Zola" />
                  </a>
                </div>
                <div class="block-content_text">
                  <a href="#">
                    <h4>All the Young People of this country are</h4>
                  </a>
                  <p>
                    Aliquam vehicula mollis urna vel dignissim. Integer
                    tincipunt <a href="#">continued</a>
                  </p>
                </div>
              </div>
              <!-- /.Block Content -->
              ...
              <div class="block-content">
                <div class="block-content_header">
                  <img src="../assets/images/profile_2.jpg" alt="Zola" />
                  <p>Ligthon Simons</p>
                </div>
                <div class="block-content_thumbnail">
                  <span class="bg-yellow">Life</span>
                  <a href="#">
                    <img src="../assets/images/thumbnail_02.jpg" alt="Zola" />
                  </a>
                </div>
                <div class="block-content_text">
                  <a href="#">
                    <h4>The Growth of more and mor Women Entrepreneurs are</h4>
                  </a>
                  <p>
                    Aliquam vehicula mollis urna vel dignissim. Integer
                    tincipunt <a href="#">continued</a>
            ...
            <div class="block-style-2">
              ...
              <div class="contents">
                ...
                <div class="thumbnail-1">
                  <span class="bg-red">Life and Arts</span>
                  <a href="#">
                    <img src="../assets/images/thumbnail_03.jpg" alt="Zola" />
                    <div class="overlay">
                      <div class="overlay-content">
                        <div class="list-users-02">
                          ...
                          <p>
                            <span>Josh Lankaster</span> and
                            <span>Sophy Clarenz</span>
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div class="content-wrapper">
                  ...
                  <div class="title">
                    <a href="#">
                      <h2>
                        More Vacationers Continue Choosing the same Destination
                        for this Summer with Their
                      </h2>
                    </a>
                  </div>
                  <!-- /.Title -->
                  ...
                  <div class="desc">
                    <p>
                      Etiam eget erat accumsan, tempus purus a, sagittis nisi.
                      Praesent laoreet interdum diam, ac ornare dolor mattis up.
                    </p>
                  </div>
                  <!-- /.Description -->
                </div>
                ...
                <!-- Peoples -->
                <div class="peoples">
                  <div class="list-users-03">
                    <ul class="images">
                      <span class="count">+172</span>
                      <li>
                        <img src="../assets/images/profile_3.jpg" alt="Zola" />
                      </li>
                      <li>
                        <img src="../assets/images/profile_4.jpg" alt="Zola" />
                      </li>
                      <li>
                        <img src="../assets/images/profile_5.jpg" alt="Zola" />
                      </li>
                      <li>
                        <img src="../assets/images/profile_6.jpg" alt="Zola" />
                      </li>
                      <li>
                        <img src="../assets/images/profile_7.jpg" alt="Zola" />
                      </li>
                    </ul>
                    <p><span>176</span> people are discussing</p>
                  </div>
                </div>
                <!-- /.Peoples -->
                <!-- Comments -->
                <div class="comments">
                  ...
                  <div class="media">
                    <div class="img-frame1">
                      <img
                        class="mr-3"
                        src="../assets/images/profile_8.jpg"
                        alt="Zola"
                      />
                    </div>
                    <div class="media-body">
                      <div class="pin">
                        ...
                        >
                          <path
                            d="M506.143,165.858l-160-160C342.393,2.107,337.305,0,332.001,0c-5.304,0-10.392,2.107-14.142,5.858
														c-9.259,9.259-13.754,25.759-20.558,50.735c-7.977,29.283-18.901,69.388-38.11,88.597c-12.397,12.397-39.128,13.456-67.429,14.577
														c-36.565,1.448-78.008,3.089-105.903,30.984c-7.811,7.811-7.811,20.474,0,28.284l90.35,90.35L5.937,477.78
														c-7.854,7.767-7.924,20.43-0.157,28.284C9.693,510.019,14.846,512,20.001,512c5.081,0,10.165-1.925,14.063-5.78l170.429-168.551
														l88.473,88.473c3.905,3.905,9.023,5.858,14.142,5.858c5.119,0,10.237-1.953,14.142-5.858c25.027-25.027,28.81-60.683,30.39-92.139
														c0.554-11.032-7.939-20.424-18.971-20.978c-11.024-0.562-20.424,7.94-20.978,18.971c-0.974,19.373-2.902,35.706-7.838,48.464
														L131.561,208.169c17.202-6.669,39.761-7.562,61.784-8.434c34.743-1.376,70.667-2.798,94.13-26.261
														c26.725-26.725,39.264-72.757,48.42-106.368c0.995-3.653,2.097-7.7,3.229-11.699l117.47,117.47c-4,1.132-8.046,2.234-11.699,3.229
														c-33.611,9.156-79.643,21.695-106.368,48.42c-7.811,7.811-7.811,20.474,0,28.284c7.811,7.81,20.474,7.811,28.284,0
														c19.209-19.209,59.313-30.133,88.597-38.11c24.976-6.804,41.476-11.298,50.735-20.558c3.751-3.75,5.858-8.838,5.858-14.142
														S509.894,169.608,506.143,165.858z"
                          />
                        </svg>
                      </div>
                      <h5 class="mt-0">
                        Mia Columbuus <span>4 hours ago</span>
                      </h5>
                      <p>
                        TGrotesque hen onto yikes where one a more trewed
                        flustered oh much like polite far ...
                      </p>
                      <!-- Replied -->
                      <div class="media mt-3">
                        <a href="#">
                          <div class="img-frame2">
                            <img
                              class="mr-3"
                              src="../assets/images/profile_9.jpg"
                              alt="Zola"
                            />
                          </div>
                        </a>
                        <div class="media-body">
                          <h5 class="mt-0">
                            Yakie Soliz <span>7 hours ago</span>
                          </h5>
                          <p>
                            Etiam eget erat accumsan, tempus purus a, sagittis
                            nisi. Praesent laoreet ...
                          </p>
                        </div>
                      </div>
                      <!-- /.Replied -->
                ...
                <div class="block-style-8">
                  ...
                  <div class="contents">
                    ...
                    <div class="thumbnail-1">
                      ...
                      <a href="#">
                        <img src="../assets/images/thumbnail_04.jpg" alt="Zola" />
                        <div class="overlay">
                          <div class="overlay-content">
                            <div class="list-users-02">
                              <ul class="images">
                                <li>
                                  <img
                                    src="../assets/images/profile_10.jpg"
                                    alt="Zola"
                                  />
                                </li>
                              </ul>
                    ...
                    <div class="content-wrapper">
                      ...
                      <div class="title">
                        <a href="#">
                          <h2>
                            Every Time the Youngest entrep- reneurs Invest in
                            the Stock Market
                          </h2>
                        </a>
                      </div>
                      ...
                      <div class="desc">
                        <p>
                          Etiam eget erat accumsan, tempus purus a, sagittis
                          nisi. Praesent laoreet interdum diam, ac ornare dolor
                          mattis up.
                        </p>
                      </div>
                      <!-- /.Description -->
                    ...
                    <div class="small-list-posts">
                      ...
                      <div class="item">
                        <a href="#">
                          <div class="thumbnail-img">
                            <img
                              src="../assets/images/thumbnail_05.jpg"
                              alt="Zola"
                            />
                          </div>
                          <div class="content">
                            <h3>
                              Welcome to Akroot is a Spe- cialized Design
                              Agency.
                            </h3>
                            <span>5 MIN READ</span>
                          </div>
                      ...
                      <div class="item">
                        <a href="#">
                          <div class="thumbnail-img">
                            <img
                              src="../assets/images/thumbnail_06.jpg"
                              alt="Zola"
                            />
                          </div>
                          <div class="content">
                      ...
                      <div class="item">
                        <a href="#">
                          <div class="thumbnail-img">
                            <img
                              src="../assets/images/thumbnail_07.jpg"
                              alt="Zola"
                            />
                          </div>
                          <div class="content">
                  ...
                  <div class="contents">
                          ...
                          <div class="overlay-content">
                            <div class="list-users-02">
                              <ul class="images">
                                <li>
                                  <img
                                    src="../assets/images/profile_11.jpg"
                                    alt="Zola"
                                  />
                                </li>
                              </ul>
                    ...
                    <div class="content-wrapper">
                      ...
                      <div class="title">
                        <a href="#">
                          <h2>
                            Trends is Now Business from Ho- me through a Smart
                            Phone
                          </h2>
                        </a>
                      </div>
                    ...
                    <div class="small-list-posts">
                      ...
                      <div class="item">
                        <a href="#">
                          <div class="thumbnail-img">
                            <img
                              src="../assets/images/thumbnail_09.jpg"
                              alt="Zola"
                            />
                          </div>
                          <div class="content">
                      ...
                      <div class="item">
                        <a href="#">
                          <div class="thumbnail-img">
                            <img
                              src="../assets/images/thumbnail_10.jpg"
                              alt="Zola"
                            />
                          </div>
                          <div class="content">
                      ...
                      <div class="item">
                        <a href="#">
                          <div class="thumbnail-img">
                            <img
                              src="../assets/images/thumbnail_11.jpg"
                              alt="Zola"
                            />
                          </div>
                          <div class="content">
                    ...
                    <div class="item">
                      <a href="#">
                        ...
                        <div class="tweet-content">
                          ...
                          <p>
                            Phasellus pulvinar iaculis nunc at placerat. Sed
                            porta sollicitudin eros, vel sagittis turpis
                            consequat <span>envato.d.pr/h7ivMe</span>
                          </p>
                        </div>
                      </a>
                    </div>
            ...
            <div class="block-style-1 v2">
              ...
              <div class="block-content">
                ...
                <div class="block-content_text">
                  <a href="#">
                    <h4>
                      According to the governor in the technological field, it
                    </h4>
                  </a>
                  <p>
                    Aliquam vehicula mollis urna vel dignissim. Integer
              ...
              <div class="block-content">
                ...
                <div class="block-content_text">
                  <a href="#">
                    <h4>
                      A study has shown that we spend more than 10 hours a
                    </h4>
                  </a>
                  <p>
                    Aliquam vehicula mollis urna vel dignissim. Integer
          ...
          <div class="col-12 col-lg-5">
            <div class="block-style-9">
              ...
              <div class="contents">
                ...
                <div class="thumbnail-1">
                  <a href="#">
                    <img src="../assets/images/thumbnail_15.jpg" alt="Zola" />
                    <div class="overlay">
                      <div class="overlay-content">
                        <div class="list-users-02">
                          <ul class="images">
                ...
                <div class="content-wrapper">
                  ...
                  <div class="title">
                    <a href="#">
                      <h2>
                        <span>NEW</span>Modeling has Been a Career and a new
                  ...
                  <div class="desc">
                    <p>
                      Vivamus dapibus et purus quis mollis. Mauris tempus tortor
                      vel mi eleifend laoreet. Nulla laoreet sapien erat, nec
                      vestibulum est volutpat <a href="#">Read More</a>
                    </p>
                  </div>
                  <!-- /.Description -->
                </div>
            ...
            <div class="block-style-9">
              ...
              <div class="contents">
                ...
                <div class="thumbnail-1">
                  <a href="#">
                    <img src="../assets/images/thumbnail_16.jpg" alt="Zola" />
                    <div class="overlay">
                      <div class="overlay-content">
                        <div class="list-users-02">
                          <ul class="images">
                            <li>
                              <img
                                src="../assets/images/profile_16.jpg"
                                alt="Zola"
                              />
                            </li>
                          </ul>
            ...
            <div class="block-style-9">
              ...
              <div class="contents">
                ...
                <div class="thumbnail-1">
                  <a href="#">
                    <img src="../assets/images/thumbnail_17.jpg" alt="Zola" />
                    <div class="overlay">
                      <div class="overlay-content">
                        <div class="list-users-02">
                          <ul class="images">
                            <li>
                              <img
                                src="../assets/images/profile_17.jpg"
                                alt="Zola"
                              />
                            </li>
                          </ul>
            ...
            <div class="block-style-9">
              ...
              <div class="contents">
                ...
                <div class="thumbnail-1">
                  <a href="#">
                    <img src="../assets/images/thumbnail_18.jpg" alt="Zola" />
                    <div class="overlay">
                      <div class="overlay-content">
                        <div class="list-users-02">
                          <ul class="images">
                            <li>
                              <img
                                src="../assets/images/profile_18.jpg"
                                alt="Zola"
                              />
                            </li>
                          </ul>
            ...
            <div class="block-style-11">
              ...
              <div class="recent-comments">
                ...
                <div class="item">
                  <a href="#">
                    <div class="comment-img">
                      <img src="../assets/images/profile_19.jpg" alt="Zola" />
                    </div>
                    <div class="comment-content">
                      <h6>45 mins ago</h6>
                      <h5>Dany Janssen <span>left this comment:</span></h5>
                      <p>
                        Etiam eget erat accumsan, tempus purus a, sagittis nisi.
                        <span>@raesent</span> lao- reet interdum diam,
                      </p>
                      <p class="btm">
                        In:
                        <strong
                ...
                <div class="item">
                  <a href="#">
                    <div class="comment-img">
                      <img src="../assets/images/profile_20.jpg" alt="Zola" />
                    </div>
                    <div class="comment-content">
                      <h6>2 hours ago</h6>
                      <h5>Rudy Thomphsoon <span>left this comment:</span></h5>
                      <p>
                        Etiam eget erat accumsan, tempus purus a, sagittis nisi.
                        <span>@raesent</span> lao- reet interdum diam,
                      </p>
                ...
                <div class="item">
                  <a href="#">
                    <div class="comment-img">
                      <img src="../assets/images/profile_21.jpg" alt="Zola" />
                    </div>
                    <div class="comment-content">
                      <h6>10 hours ago</h6>
                      <h5>Michell Lypsi <span>left this comment:</span></h5>
                      <p>
                        Etiam eget erat accumsan, tempus purus a, sagittis nisi.
                        <span>@raesent</span> lao- reet interdum diam,
                      </p>
                ...
                <div class="item">
                  <a href="#">
                    <div class="comment-img">
                      <img src="../assets/images/profile_22.jpg" alt="Zola" />
                    </div>
                    <div class="comment-content">
                      <h6>12 hours ago</h6>
                      <h5>Vinnie Boombotz <span>left this comment:</span></h5>
                      <p>
                        Etiam eget erat accumsan, tempus purus a, sagittis nisi.
                        <span>@raesent</span> lao- reet interdum diam,
                      </p>
                ...
                <div class="item">
                  <a href="#">
                    <div class="comment-img">
                      <img src="../assets/images/profile_23.jpg" alt="Zola" />
                    </div>
                    <div class="comment-content">
                      <h6>15 mins ago</h6>
                      <h5>Mina Jokovic <span>left this comment:</span></h5>
                      <p>
                        Etiam eget erat accumsan, tempus purus a, sagittis nisi.
                        <span>@clorper</span> lao- reet interdum diam,
                      </p>
                      <p class="btm">
                        In:
                        <strong
