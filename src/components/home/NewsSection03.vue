      ...
      <div class="contents">
        ...
        <div class="content-wrapper">
          ...
          <div class="title">
            <a href="#">
              <h2>
                <span>NEW</span>Modeling has Been a Career and a new Boom in
            ...
            <div class="overlay">
              <div class="overlay-content">
                <div class="list-users-02">
                  <ul class="images">
                    <li>
                      <img src="../../assets/images/profile_16.jpg" alt="Zola" />
                    </li>
                  </ul>
                  <p><span>Lily Lover</span></p>
                </div>
            ...
            <div class="overlay">
              <div class="overlay-content">
                <div class="list-users-02">
                  <ul class="images">
                    <li>
                      <img src="../../assets/images/profile_17.jpg" alt="Zola" />
                    </li>
                  </ul>
                  <p><span>Lily Lover</span></p>
                </div>
            ...
            <div class="overlay">
              <div class="overlay-content">
                <div class="list-users-02">
                  <ul class="images">
                    <li>
                      <img src="../../assets/images/profile_18.jpg" alt="Zola" />
                    </li>
                  </ul>
                  <p><span>Lily Lover</span></p>
                </div>
